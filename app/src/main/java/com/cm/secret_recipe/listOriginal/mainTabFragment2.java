...
public class mainTabFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = menu_original.ARRAY_BEVERAGE.length-1; i>=0; --i){
            adapter.add(createMainList(menu_original.ARRAY_BEVERAGE[i].menuName, menu_original.ARRAY_BEVERAGE[i].drawableID),position);
